...
-- ALARMES
INSERT INTO ALARMS (ALM_ID,ALM_DESCRIPTION,ALM_NORM_MAN,ALM_NORM_ID,ALM_GROUP_ID,ALM_TYPE_ID,ALM_MODEL_ID,ALM_SEVERITY_ID,ALM_COUNTER_INC,USR_INSERT,ALM_NORM_ALM) VALUES ('XPTOSEM'	,'ALARME SEVERIDADE: SEM SEVERIDADE'	,1,null,1,1,1,'0',1,'JOABRE',2);
INSERT INTO ALARMS (ALM_ID,ALM_DESCRIPTION,ALM_NORM_MAN,ALM_NORM_ID,ALM_GROUP_ID,ALM_TYPE_ID,ALM_MODEL_ID,ALM_SEVERITY_ID,ALM_COUNTER_INC,USR_INSERT,ALM_NORM_ALM) VALUES ('XPTONORMAL'	,'ALARME SEVERIDADE: NORMAL'			,1,null,1,1,1,'1',1,'JOABRE',2);
INSERT INTO ALARMS (ALM_ID,ALM_DESCRIPTION,ALM_NORM_MAN,ALM_NORM_ID,ALM_GROUP_ID,ALM_TYPE_ID,ALM_MODEL_ID,ALM_SEVERITY_ID,ALM_COUNTER_INC,USR_INSERT,ALM_NORM_ALM) VALUES ('XPTOLEVE'	,'ALARME SEVERIDADE: LEVE'				,1,null,1,1,1,'2',1,'JOABRE',2);
INSERT INTO ALARMS (ALM_ID,ALM_DESCRIPTION,ALM_NORM_MAN,ALM_NORM_ID,ALM_GROUP_ID,ALM_TYPE_ID,ALM_MODEL_ID,ALM_SEVERITY_ID,ALM_COUNTER_INC,USR_INSERT,ALM_NORM_ALM) VALUES ('XPTOGRAVE'	,'ALARME SEVERIDADE: GRAVE'				,1,null,1,1,1,'3',1,'JOABRE',2);

-- ALARMES TESTE DE NORMALIZAÇÃO
INSERT INTO ALARMS (ALM_ID,ALM_DESCRIPTION,ALM_NORM_MAN,ALM_NORM_ID,ALM_GROUP_ID,ALM_TYPE_ID,ALM_MODEL_ID,ALM_SEVERITY_ID,ALM_COUNTER_INC,USR_INSERT,ALM_NORM_ALM) VALUES ('XPTONRM'	,'ALARME SEVERIDADE: GRAVE'				,1,null		,1,1,1,'3',1,'JOABRE',1);
INSERT INTO ALARMS (ALM_ID,ALM_DESCRIPTION,ALM_NORM_MAN,ALM_NORM_ID,ALM_GROUP_ID,ALM_TYPE_ID,ALM_MODEL_ID,ALM_SEVERITY_ID,ALM_COUNTER_INC,USR_INSERT,ALM_NORM_ALM) VALUES ('XPTOALM'	,'ALARME SEVERIDADE: GRAVE'				,1,'XPTONRM',1,1,1,'2',1,'JOABRE',2);
