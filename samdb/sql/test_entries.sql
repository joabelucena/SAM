...
-- ALARMES
INSERT INTO ALARMS (ALM_ID,ALM_DESCRIPTION,ALM_MAN_NORM,ALM_PARENT_ID,ALM_GROUP_ID,ALM_TYPE_ID,ALM_MODEL_ID,ALM_SEVERITY_ID,ALM_COUNTER_INC,USR_INSERT,DTI_INSERT,USR_UPDATE,DTI_UPDATE,DELETED) VALUES ('XPTOSEM','ALARME SEVERIDADE: SEM SEVERIDADE'	,1,null,1,1,1,'0',1,'JOABRE',{ts '2011-01-30 23:32:28.'},null,null,' ');
INSERT INTO ALARMS (ALM_ID,ALM_DESCRIPTION,ALM_MAN_NORM,ALM_PARENT_ID,ALM_GROUP_ID,ALM_TYPE_ID,ALM_MODEL_ID,ALM_SEVERITY_ID,ALM_COUNTER_INC,USR_INSERT,DTI_INSERT,USR_UPDATE,DTI_UPDATE,DELETED) VALUES ('XPTONORMAL','ALARME SEVERIDADE: NORMAL'		,1,null,1,1,1,'1',1,'JOABRE',{ts '2011-01-30 23:32:28.'},null,null,' ');
INSERT INTO ALARMS (ALM_ID,ALM_DESCRIPTION,ALM_MAN_NORM,ALM_PARENT_ID,ALM_GROUP_ID,ALM_TYPE_ID,ALM_MODEL_ID,ALM_SEVERITY_ID,ALM_COUNTER_INC,USR_INSERT,DTI_INSERT,USR_UPDATE,DTI_UPDATE,DELETED) VALUES ('XPTOLEVE','ALARME SEVERIDADE: LEVE'			,1,null,1,1,1,'2',1,'JOABRE',{ts '2011-01-30 23:32:28.'},null,null,' ');
INSERT INTO ALARMS (ALM_ID,ALM_DESCRIPTION,ALM_MAN_NORM,ALM_PARENT_ID,ALM_GROUP_ID,ALM_TYPE_ID,ALM_MODEL_ID,ALM_SEVERITY_ID,ALM_COUNTER_INC,USR_INSERT,DTI_INSERT,USR_UPDATE,DTI_UPDATE,DELETED) VALUES ('XPTOGRAVE','ALARME SEVERIDADE: GRAVE'			,1,null,1,1,1,'3',1,'JOABRE',{ts '2011-01-30 23:32:28.'},null,null,' ');
