...
CREATE TABLE SERVICE_ORDER_SERVICES (
  SOV_ID VARCHAR(2) NOT NULL PRIMARY KEY,
  SOV_DESCRIPTION VARCHAR(45) NOT NULL,
  USR_INSERT VARCHAR(45) NOT NULL,
  DTI_INSERT TIMESTAMP NOT NULL,
  USR_UPDATE VARCHAR(45),
  DTI_UPDATE TIMESTAMP,
...
/*INDEXES*/
CREATE INDEX ix_SOV_INDEX1_idx ON SERVICE_ORDER_SERVICES(SOV_DESCRIPTION);
...
/*TRIGGER LOG*/
SET TERM ^ ;
CREATE TRIGGER TRG_SOV_LOG  FOR SERVICE_ORDER_SERVICES ACTIVE
BEFORE INSERT OR UPDATE
AS
BEGIN
	if(inserting)
...
CREATE INDEX fk_SOO_SOV_idx ON SERVICE_ORDER_OCCURRENCES(SOO_SERVICE_ID);
CREATE INDEX fk_SOO_SOR_idx ON SERVICE_ORDER_OCCURRENCES(SOO_SERVICE_ORDER_ID);
  
/*REFERENCES*/
ALTER TABLE SERVICE_ORDER_OCCURRENCES
ADD CONSTRAINT fk_SOO_SOV_ref
    FOREIGN KEY (SOO_SERVICE_ID)
    REFERENCES SERVICE_ORDER_SERVICES (SOV_ID),
