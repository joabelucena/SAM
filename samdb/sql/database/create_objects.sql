...
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Papéis de Usuários'			,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros'),'userrolegrid');
...
CREATE TABLE ALARMS (
  ...
  ,ALM_NORM_MAN		INT			NOT NULL
  ,ALM_NORM_ALM		INT			NOT NULL
...
CREATE TABLE TASK_MONITOR_ITEMS (
  ...
  TMI_SEQ			VARCHAR(2)	NOT NULL,
  TMI_LOGIC_OP		VARCHAR(3)	NOT NULL,
  TMI_FIELD			VARCHAR(45)	NOT NULL,
  TMI_RELATIONAL_OP VARCHAR(2)	NOT NULL,
