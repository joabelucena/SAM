...
FROM
	ROLE
WHERE
	ROLENAME IN ('BASE A', 'BASE B', 'OPERACAO (BASE A)','OPERACAO (BASE B)');
...
FROM
	ROLE
WHERE
	ROLENAME IN ('OPERACAO (BASE A)','OPERACAO (BASE B)');
...
FROM
	ROLE
WHERE
	ROLENAME IN ('CCO','BASE A', 'BASE B', 'OPERACAO (BASE A)','OPERACAO (BASE B)');
