...
INSERT INTO MENU (TYPE,URL,TEXT,PARENT_ID,CLASSNAME)VALUES('PN',NULL,'Regras de Mud. de Est.'					,(SELECT ID FROM MENU WHERE TEXT = 'Ordem de Serviço' AND PARENT_ID IS NULL),'serviceorderrulesgrid');
...
INSERT INTO MENU (TYPE,URL,TEXT,PARENT_ID,CLASSNAME)VALUES('PN',NULL,'Sub-Sistemas'								,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'systemgrid');
...
CREATE TABLE EQUIPMENTS (
  ...
  ,EQU_INSTALL_DATE		TIMESTAMP
  ,EQU_MANUFACTURE_DATE	TIMESTAMP
  ,EQU_ACQUIRED_DATE	TIMESTAMP
