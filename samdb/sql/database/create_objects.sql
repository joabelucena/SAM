...
INSERT INTO SERVICE_ORDER_STATUS (SOS_DESCRIPTION,USR_INSERT,SOS_LOG_REMARK,SOS_FEAT_ID) VALUES ('ATRIBUIDA'				,'SYSTEM','Y',(SELECT ID FROM SYS_FEATURES WHERE DESCRIPTION = 'Atribuir Técnico')	);
