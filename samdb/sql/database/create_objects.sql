...
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Alarmes',(SELECT ID FROM MENU WHERE TEXT = 'Inicio' AND PARENT_ID IS NULL),'eventgrid');

-- Sub-Menu: Ordem de Serviço
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Ordem de Serviço',NULL,'');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Ordens de Serviço'	,(SELECT ID FROM MENU WHERE TEXT = 'Ordem de Serviço' AND PARENT_ID IS NULL),'serviceordergrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Tipos de Serviços'	,(SELECT ID FROM MENU WHERE TEXT = 'Ordem de Serviço' AND PARENT_ID IS NULL),'serviceorderjobgrid');

-- Sub-Menu: Cadastros
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Cadastros',NULL,'');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Fabricante de Equipamentos'	,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'equipmentmanufacturergrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Modelos de Equipamentos'		,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'equipmentmodelgrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Tipos de Equipamentos'		,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'equipmenttypegrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Técnicos'					,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'techniciangrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Protocolos de Equipamentos'	,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'equipmentprotocolgrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Estado Operacional'			,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'operationalstategrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Sub-Sistemas'				,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'subsystemgrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Base de Manutenção'			,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'stationgrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Niveis de Severidade'		,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'severitygrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Alarmes'						,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'alarmgrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Tipos de Alarmes'			,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'alarmtypegrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Grupos de Alarmes'			,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'alarmgroupgrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Filtro de Alarmes'			,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'alarmfiltergrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Tipos de Documentos'			,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'documenttypegrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Tipos de Locais'				,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'sitetypegrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Locais'						,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'sitegrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Tipos de OS'					,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'serviceordertypegrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Status de OS'				,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'serviceorderstatusgrid');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Regras de Supervisao'		,(SELECT ID FROM MENU WHERE TEXT = 'Cadastros' AND PARENT_ID IS NULL),'taskgrid');

-- Sub-Menu: Relatórios
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Relatórios',NULL,'');
INSERT INTO MENU (TEXT,PARENT_ID,CLASSNAME)VALUES('Relatórios'	,(SELECT ID FROM MENU WHERE TEXT = 'Relatórios' AND PARENT_ID IS NULL),'spagobi');
...
CREATE TABLE ALARMS (
  ...
  ,ALM_COUNTER_INC	CHAR(1)		NOT NULL
  ,USR_INSERT		VARCHAR(45) NOT NULL
  ,DTI_INSERT		TIMESTAMP	NOT NULL
  ,USR_UPDATE		VARCHAR(45) 
  ,DTI_UPDATE		TIMESTAMP);
...
CREATE TABLE TASK_MONITOR_HEADER (
  ...
  TMH_ALARM_ID	VARCHAR(20)	NOT NULL,
  USR_INSERT	VARCHAR(45)	NOT NULL,
  DTI_INSERT	TIMESTAMP	NOT NULL,
  USR_UPDATE	VARCHAR(45),
  DTI_UPDATE	TIMESTAMP
...
/******* END OF TABLE CONFIG *******//* Table:		PARAMETERS
 * Prefix:		PAR
 * Date:		31/10/2014       
 * Author:		Joabe Lucena
 * References:	none
